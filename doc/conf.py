...
htmlhelp_basename = 'ckanservicedoc'
...
latex_documents = [
  ('index', 'ckanservice.tex', u'CKAN Service Provider Documentation',
...
man_pages = [
    ('index', 'ckanservice', u'CKAN Service Provider Documentation',
...
texinfo_documents = [
  ('index', 'ckanservice', u'CKAN Service Provider Documentation', u'Open Knowledge Foundation',
